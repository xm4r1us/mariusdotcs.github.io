...
if(user.activities){ var ela = "I'm in "+user.activities[1].name+" now."; var ela2 =1; }else{ var ela = ""}}
            ...
            try{if(ela){elements.gameX.innerText = ela;elements.gameX.innerHTML = elements.gameX.innerHTML +'<img src="https://cdn.discordapp.com/app-assets/'+user.activities[1].application_id+'/'+user.activities[1].assets.large_image+'" >'}}catch(err){}
